    ...
    renderContainer.innerHTML = posts
        .map((post) => {
            ...
            if (type === 'bids') {
                ...
                mediaUrl =
                    post.listing.media && post.listing.media.length > 0
                        ? post.listing.media[0].url
                        : 'https://upload.wikimedia.org/wikipedia/commons/f/f9/No-image-available.jpg';
                mediaAlt =
                    post.listing.media && post.listing.media.length > 0
                        ? post.listing.media[0].alt || 'Listing Image'
                        : 'No Image Available';
            ...
            return `
                <div data-id="${
                    type === 'bids' ? post.listing.id : post.id
    ...
    if (type !== 'bids') {
        countdownInterval = setInterval(() => {
            const countdownElements =
                renderContainer.querySelectorAll('.countdown');
